...
A week has passed. Odessa stands outside an ancient temple, its walls covered in intricate mosaics—each tile a spell record, perfectly arranged and organized. Inside, Master Architect Nyx awaits, surrounded by blueprints of impossible complexity.

"You've learned the fundamentals," Nyx says, gesturing broadly. "But the real power of Move isn't in simple spells. It's in architecture—how you organize data, how you compose systems, how you build things that scale."

Nyx pulls out a crystal that shimmers with internal structure. "Look closely. What do you see?"

Odessa peers into it. Layer upon layer of nested geometry, each layer containing others, all perfectly organized.

"This is a **struct**," Nyx explains. "Not just a container—it's a schema. A blueprint for reality. When you define a struct, you're saying: 'This is what a Spell looks like. This is what data goes together. This is my domain.'

Nyx sets it down and looks into Odessa's eyes. "In other lands, programmers throw data into hashmaps and arrays, hoping no one mixes them up. Here, every piece of data is _typed_. Every spell record knows exactly what it contains. Every transaction knows exactly what it's modifying."

"Today, you'll learn to build your first real data structures. Structs, composition, and the phantom types that guard your domain. By day's end, you'll have built a real system—a Spell Registry that can store complex spell records forever on the blockchain."
