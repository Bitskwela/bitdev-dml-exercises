...
# Step 0: A small sample dataset kept inline as a CSV string.
# We use io.StringIO so the lesson runs anywhere — including the
# in-browser sandbox — without writing to disk.
...
# TODO: Step 1 — Read the CSV
# Use csv.DictReader on StringIO(SAMPLE_CSV) to turn each row into a dict.
