...
![Cover Image](https://bitdev-dml-assets.s3.ap-southeast-1.amazonaws.com/ch_7/C7+31.0+-+COVER.png)
...
![image](https://bitdev-dml-assets.s3.ap-southeast-1.amazonaws.com/ch_7/C7+31.1.png)
  ...
  <body>
    ...
    <form id="serviceForm">
      ...
      <div class="form-group">
        ...
        <label for="isPWD" style="display: inline;"
    ...
    <script>
        ...
        if (baseFee > 0) {
          ...
          if (discount > 0) {
            ...
            document.querySelector("#discountPercent").textContent =
              discount * 100;
            document.querySelector("#discountReason").textContent =
              discountReason;
          } else {
      ...
      form.addEventListener("submit", function (event) {
        ...
        confirmation.innerHTML = `
                ...
                ${
                  discount > 0
                    ? `<p><strong>Discount:</strong> ${discountReason}</p>`
                    : ""
                }
