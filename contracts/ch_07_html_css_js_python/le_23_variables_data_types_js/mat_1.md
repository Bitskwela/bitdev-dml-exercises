...
![Cover Image](https://bitdev-dml-assets.s3.ap-southeast-1.amazonaws.com/ch_7/C7+23.0+-+COVER.png)
...
![image](https://bitdev-dml-assets.s3.ap-southeast-1.amazonaws.com/ch_7/C7+23.1.png)
...
"Then that's your next step. HTML is structure. CSS is presentation. JavaScript is behavior—it makes websites _do_ things. Without it, you're building digital brochures, not web applications."
...
"Ms. Santos is right," Rhea Joy said quietly. "It looks great, but it doesn't _do_ anything. It's like a car that looks amazing but has no engine."
...
"Perfect. We're starting JavaScript. And I mean really starting—from the absolute foundation. Variables, data types, how to think in code. JavaScript is different from HTML and CSS. It's not declarative—it's imperative. You're not describing what things _are_, you're instructing what things should _do_. It requires a different mindset. But once you get it, everything changes. Your websites go from static pages to living, breathing applications."
