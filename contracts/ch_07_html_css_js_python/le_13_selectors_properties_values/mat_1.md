...
Tian mastered CSS selectors: element, class, ID, descendant, pseudo-classes. Every element on the page could now be targeted precisely.

"Selectors are like addresses," Kuya Miguel explained. "You're telling the browser: 'Find this specific element and apply these styles.'"
