...
Tian closed the laptop with a satisfied grin. The mystery was solved. All those years of typing URLs and watching pages loadnow it all made sense. Request, DNS lookup, TCP handshake, HTTP response, rendering. Simple. Elegant. Beautiful.

"So Facebook isn't really 'loading,'" Tian muttered. "My browser is just asking Facebook's server for files, and the server is replying. Like ordering food at a carinderia!"

Kuya Miguel laughed through the video call. "Exactly! And guess what? Now that you understand how the web works, you're ready to build your own websites. Static or dynamicyour choice."

Tian's eyes lit up. "I want to build a website for our barangay. Something simple firstjust HTML. Then maybe add a database later for resident records."

"Perfect," said Kuya Miguel. "That's the right mindset. Start small, iterate, scale. Just like how Facebook started in a dorm room."
