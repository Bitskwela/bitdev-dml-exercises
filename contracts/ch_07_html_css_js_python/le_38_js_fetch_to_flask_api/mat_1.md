...
![Cover Image](https://bitdev-dml-assets.s3.ap-southeast-1.amazonaws.com/ch_7/C7+38.0+-+COVER.png)
...
![image](https://bitdev-dml-assets.s3.ap-southeast-1.amazonaws.com/ch_7/C7+38.1.png)
            ...
            (complaint) => `
                <div class="complaint-card">
                    ...
                    <p><span class="status status-${
                      complaint.status
                    }">${complaint.status.toUpperCase()}</span></p>
                    <div class="actions">
                        ${
                        ...
                        <button class="btn-delete" onclick="deleteComplaint(${
                          complaint.id
                        })">Delete</button>
                    </div>
                </div>
