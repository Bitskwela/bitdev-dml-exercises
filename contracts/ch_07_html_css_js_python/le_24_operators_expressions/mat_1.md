...
![Cover Image](https://bitdev-dml-assets.s3.ap-southeast-1.amazonaws.com/ch_7/C7+24.0+-+COVER.png)

Tian had learned variables and data types. They could store information—names, ages, fees, quantities. Their JavaScript could remember things. But it couldn't _do_ anything with that data yet.
...
![image](https://bitdev-dml-assets.s3.ap-southeast-1.amazonaws.com/ch_7/C7+24.1.png)
