...
Odessa stands on the edge of a crystalline cliff, overlooking the Vault of Transactions. Below, she sees thousands of spell transfers happening simultaneously—each one glowing briefly before settling into the ledger.

A mysterious figure emerges from the mist. It is Lyra, the Keeper of Invariants, the guardian of the linear type system itself.

"You've learned about resources," Lyra begins, her voice like wind through ancient canyons. "But understanding them intellectually is not the same as comprehending their true power."

Lyra points down at a spell being transferred. As it moves from one caster to another, it glows with a brilliant blue light—the light of the linear type system.

"In other lands, when someone transfers value, nobody truly knows if the transfer is legitimate. How many copies were made? Were the bytes corrupted? Did someone duplicate the transfer? The answer is unknowable because the system trusts humans."

"Here, Move trusts nothing. Move uses mathematics itself—the Linear Type System—to prove that every resource has exactly one owner at any moment. No copies. No duplicates. No disappearances."

Lyra turns to face Odessa directly. "A resource is not just data. A resource is a _guarantee_. When you transfer a resource, the blockchain can prove—with mathematical certainty—that the sender no longer has it and the receiver now does. No trust needed. No auditors required. The math speaks for itself."

"Today, you'll learn the deepest magic: Resource Invariants, Linearity, and the Art of Building Trustless Systems."
