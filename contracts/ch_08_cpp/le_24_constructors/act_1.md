# C++ Activity: Constructors

Ensure your objects start with valid data using constructors.
...
public:
    // Your code here: Implement a default constructor

    // Your code here: Implement a parameterized constructor
...
int main() {
    // Your code here: Create a Resident using the default constructor

    // Your code here: Create a Resident using the parameterized constructor
...
Topics Covered: Default Constructors, Parameterized Constructors, Initialization Lists.

1. **Default Constructor**: Implement a constructor with no parameters that sets `name` to "Unknown" and `age` to 0.
2. **Parameterized Constructor**: Implement a constructor that takes a `string n` and `int a` as arguments to initialize the members.
3. **Object Creation**: In `main`, create one `Resident` object using each constructor.
4. **Verify**: Call the `display()` method for both objects to confirm they were initialized correctly. return 0;
   }
