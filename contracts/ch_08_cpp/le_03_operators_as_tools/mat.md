...
**Task:** Create a calculator that performs all arithmetic operations on two numbers.
...
**Task:** Check if a number is even or odd using modulo operator.
...
**Task:** Check if a student qualifies for scholarship:
- GPA >= 85 AND family income <= 30,000
...
**Task:** Convert Celsius to Fahrenheit using formula: F = (C × 9/5) + 32
