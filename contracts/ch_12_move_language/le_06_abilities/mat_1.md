...
Odessa, MoveStack's security specialist, wheels her chair into the center of the development area. On her screen, she has a Move module flagged by the audit system.

"Heads up, team," Odessa calls out. Neri and Ronnie gather around her workstation. "We've got a struct without abilities. Could be intentional. Could be a bug. We need to understand what the original developer was thinking."

Ronnie peers at the code. "Four sigils in Move—copy, drop, store, key. The combination you choose determines what your type can do."

Odessa brings up a comparison table. "Copy means data can be duplicated freely. Drop means it can be discarded. Store means it persists in global storage. Key means it can anchor other values."

"And if a struct has *no* abilities?" Neri asks.

"Then it's a resource," Odessa explains. "The strictest data type. Can't be copied, can't be dropped, can't be stored casually. The compiler tracks every single instance. Perfect for tokens, NFTs, access rights—anything that shouldn't be duplicated."

Ronnie nods slowly. "So the missing abilities weren't a bug. They were security."

"Exactly," Odessa says. "Today we audit MoveStack's types. We'll annotate abilities deliberately, not accidentally. By the end, you'll know exactly why certain types are restricted and how to design types that are unbreakable."
