...
Odessa sits across from Master Cipher in a dimly lit chamber. The walls are lined with scrolls, each bearing witness to countless programmers' mistakes. "You mastered the primitives," Cipher says, tapping a crystal staff against the stone floor. "But there's a deeper truth you must understand."

Cipher gestures to the air, and ghostly images appear—lines of code tangling and breaking. "In most programming lands, variables are passengers on a ship with no captain. They move around, get copied, shared, lost. But here in Move, we asked: _What if variables had souls? What if each one knew its purpose and jealously guarded it?_"

Odessa leans forward, transfixed.

"Today's lesson is called 'Every Variable Matters,' and I'll teach you why," Cipher continues. "Move has a secret weapon: the **Ownership System**. Every value has exactly one owner. When that owner is done with the value, it _moves_ away—passed to someone else, consumed, or destroyed. No more copying secretly. No more dangling pointers. No more use-after-free bugs."

Cipher snaps his fingers, and a glowing chain appears, linking one crystal to another. "This is **Scope and Lifetime**—how long a variable lives and who controls it. Understand this, and you'll write code that is not just safe, but _provably_ safe. The compiler verifies it all."

"By the end of this lesson, you'll understand why Move developers sleep better at night than those in other lands."
